...
import pickle 
import time
diabetes_model=pickle.load(open("/Users/arpitpatel/Desktop/ml/ml projects/trained_diabetes_model.sav",'rb'))
heart_disease_model=pickle.load(open("/Users/arpitpatel/Desktop/ml/ml projects/trained_heat_disease_model.sav",'rb'))
